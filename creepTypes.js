let creepTypes = {
    'harvester': {body: [WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE], num: 7},
    'builder': {body: [WORK, WORK, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE], num: 2},
    'upgrader': {body: [WORK, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE], num: 1},
    'repairer': {body: [WORK, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE], num: 2},
